...
let g:airline_extensions = ['ale', 'branch', 'bufferline', 'csv', 'fzf', 'hunks', 'keymap', 'languageclient', 'lsp', 'quickfix', 'searchcount', 'tabline', 'term', 'virtualenv', 'whitespace', 'wordcount']
